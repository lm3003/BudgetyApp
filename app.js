...
var budgetController=(function(){
    ...
    var nodeForEachLoop = function(fields, callBackFunction){
                for(var i=0; i < fields.length; i++){
                    callBackFunction(fields[i], i);
        }
    };
    return{
...
var UIController=(function(){
    ...
    return{
        ...
        displayPercentages: function(percentages){
            ...
            nodeForEachLoop(fields, function(current, index){
               //update percentage scores for each expense field
        ...
        displayMonth: function(){
            var now, day, month, year, monthArray;
            now = new Date();
            year = now.getFullYear();
            month = now.getMonth();
            monthArray = ['January' , 'February' , 'March' , 'April' , 'May' , 'June' , 'July' , 'August' , 'September' , 'October' , 'November' , 'December'];
            
            document.querySelector(DOMStrings.dataLabel).textContent = monthArray[month] + ' ' + year;
        },
        changeType: function(){
            var fields = document.querySelectorAll(
                DOMStrings.inputType + ',' +
                DOMStrings.inputDescription + ',' + DOMStrings.inputValue);
                nodeForEachLoop(fields, function(current){
...
var controller=(function(budgetCtrl, UICtrl){
    ...
    var controlDeleteItem = function(event){
        ...
        //Update the budget and show the budget
        updateBudget();
            
        //Update percentages and show on UI
        updatePercentages();
        }
    };
    return{
